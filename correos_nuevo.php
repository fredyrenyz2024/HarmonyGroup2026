...
try {
  ...
  $sql = $conexion->prepare("SELECT m.id AS manifiesto_id, oc.cli_id AS cliente_id, /* ce.man_plantilla, */ce.logo_cliente,ce.nombre_cliente FROM cmx_manifiesto m
  ...
  WHERE m.estado_seguimiento = 'SEGUIMIENTO' AND ir.num_manifiesto IS NOT NULL AND ce.envia_correo='SI'/* AND oc.cli_id=455 */
