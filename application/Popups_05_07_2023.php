						...
						if(origen){
							...
							switch (origen){
								case "clientes/bodegas":
										...
										switch ( arrayData[0] ){
											...
											case "documento":
												if (!arrayData[1]){
													...
													if(tipo_documento == "Cedula de Ciudadania" || tipo_documento == "Cedula de Extranjeria"){
											...
											case "contacto":
												if(tipo_documento == "NIT" || tipo_documento == "Identificación Tributaria Internacional"){
													if (!arrayData[1]){
									...
									if( !msg_error && ($("#slct_pais_").val() == "COLOMBIA" || tipo_documento == "Identificación Tributaria Internacional") ){
										$(".nexos-messages").html("");
						...
						if(!msg_error){
							...
							$.ajax({
								...
								success		: function(data) {
											...
											setTimeout(function() { location.reload(false);  }, 900)*/	
								}
							});
