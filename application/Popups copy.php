							...
							switch (origen){
								case "clientes/bodegas":
									...
									if (!msg_error && ($("#slct_pais_").val() == "COLOMBIA" || $("#tipo_documento").val() == "Identificación Tributaria Internacional")) {
											...
											let documento = $("#documento").val(); // <--- AQUÍ TOMAS EL DOCUMENTO
											let tipo_documento = $("#tipo_documento").val(); // "NIT" o "CC"
											let tipo_tercero = 2
											let usuario = $("#nom_user").val();

											$.ajax({
												url: "http://127.0.0.1:8000/api/v1/rndc/crear-remitente-destinatario",
												type: "POST",
												data: JSON.stringify({
													documento: documento,
										...
										if (!data.success) {
											...
											$(".nexos-messages").append(
												"<div class="alert alert-danger alert-icon alert-icon-border alert-dismissible">" +
													...
													"<div class="message">" +
														...
														"<strong>Detalle:</strong> " + (data.error ? data.error : "Sin detalles") +
													"</div>" +
												"</div>"
											);
										...
										// ÉXITO
										$(".nexos-messages").append(
											"<div class="alert alert-success alert-icon alert-icon-border alert-dismissible">" +
												...
												"<div class="message">" +
													...
													"Acción: " + data.accion + "<br>" +
													"Estado RNDC: " + data.estado + "<br>" +
