...
class Proveedores
{
    ...
    public function crearProveedor()
    {
        ...
        if ($_flag_proceso) {
            ...
            if ($Conductor == "true") {
                ...
                $sql_block = "INSERT INTO cmx_estado_bloqueo VALUES (NULL,'modificar','desbloqueado'," . $id_proveedor . ",'proveedor','" . $fecha_actual . "','" . $hora_actual . "','" . $user . "')";
                ...
                if ($total == 0) {
                    //insertar referencias laborales
                    //crear las rutas
                    ...
                    $sql_rl1 = "INSERT INTO cmx_referencias_preestudio
					        ...
					        VALUES(null,'$referencias_empresariales ','$fecha_ereferencia1','$fecha_retiro1','$contacto_ref1','$celular_ref1','$cargo_ref1','$numero_documento','$anti_ref1','$ruta_empresarial11','$name_soporte','$fecha_actual','$hora_actual','$user','1');";
                    //  echo $sql_rl1;
                    ...
                    $sql_rl2 = "INSERT INTO
					        ...
					        VALUES(null,'$referencia_empresarial2','$fecha_ereferencia2','$fecha_retiro2','$contacto_ref2','$celular_ref2','$cargo_ref2','$numero_documento','$anti_ref2','$ruta_empresarial22','$name_soporte2','$fecha_actual','$hora_actual','$user','1');";
                    // echo $sql_rl2;
                    ...
                    $sql_rl3 = "INSERT INTO
					        cmx_referencias_preestudio
					        (id,nombre_empresa,fecha_ingreso,fecha_retiro,persona_contacto,celular,cargo,id_conductor,antiguedad,documento_empresarial,name_documento,fecha,hora,usuario,estado)
					        VALUES(null,'$referencias_empresariales3','$fecha_referencia3','$fecha_retiro3','$contacto_ref3','$celular_ref3','$cargo_ref3','$numero_documento','$anti_ref3','$ruta_empresarial33','$name_soporte3','$fecha_actual','$hora_actual','$user','1');";
                    // echo $sql_rl3;
                    ...
                    $sqlr1 = "UPDATE cmx_referencias_preestudio
								SET id_conductor=" . $numero_documento . ",
                ...
                $ruta_licencia = "../public/files/proveedores/licencias/" . $id_proveedor . "/";
                $ruta_licencias = "public/files/proveedores/licencias/" . $id_proveedor . "/";
                $sqll = "UPDATE cmx_proveedores SET subir_licencia ='$ruta_licencias', n_docu_licencia='$name_doculice' WHERE id = " . $id_proveedor . "";
                $consulta_li_proveedor = $conexion->prepare($sqll);
                $consulta_li_proveedor->execute();
            ...
            if ($Proveedor == "true") {
                ...
                if (
                    $tiposervicio == 'Adecuaciones' || $tiposervicio == 'Aduana' ||
            ...
            $sql_m = "SELECT * FROM cmx_modulos WHERE estado='Activo'";
            $crear_solicitud = $conexion->prepare($sql_m);
            $result = $crear_solicitud->execute();
    ...
    //     if ($c == 1) {
    //         $sql2 = "UPDATE cmx_detalle_conductor
