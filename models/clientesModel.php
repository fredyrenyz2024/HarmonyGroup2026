...
// 			// Se recorre contenido de la consulta
// 			if ($array) {
// 				$select = '<select class="form-control form-control-sm" name="' . $name . '" id="slct_' . $name . '" aria-hidden="true">';
// 				$select .= '<option value="" selected>Seleccione</option>';
...
// 	// 					<input class="' . $class . ' form-check-input" id="' . $value . '" type="checkbox" ' . $_flag_checked . '>
...
// 			$arrayServicio = explode(",", $type);
// 		}

// 		// Construcción del contenido HTML
// 		$content = '
//         <div class="form-group col-xs-12">
//             <label class="form-label fw-blod">Servicios</label>
// 			<br>';
...
// 			if ($id_cliente) {
// 				if ($this->getServicioCliente($id_cliente, $servicio)) {
// 					$_flag_checked = 'checked';
// 				}
// 			}
...
// 			$content .= '
//             <div class="form-check form-check-inline form-switch">
//                 <input class="' . htmlspecialchars($class) . ' form-check-input" 
//                        id="' . htmlspecialchars($servicio) . '" 
//                        type="checkbox" ' . $_flag_checked . '>
//                 <label for="' . htmlspecialchars($servicio) . '">' . htmlspecialchars($servicio) . '</label>
//             </div>
//         ';
// 		}
...
// 	// 	$sql = 'SELECT * FROM cmx_clientes_serv_contratados ccsc
...
// 	// 		$arrayTipoActividad = explode(",", $value["Type"]);
// 	// 	}
// 	// 	$select = '<select class="form-select form-control-sm" name="' . $name . '" id="slct_' . $name . '_' . $id . '">';
...
// 	public function getEnumSlctTipoDocumento_sm($name, $id, $value_select)
// 	{
// 		$sql = "SHOW COLUMNS FROM cmx_clientes LIKE 'tipo_documento'";
// 		$stmt = $this->_db3->prepare($sql);
// 		$stmt->execute();
// 		$result = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
// 		$arrayTipoActividad = [];
// 		foreach ($result as $row) {
// 			$type = str_replace(["enum(", ")", "'"], "", $row["Type"]);
// 			$arrayTipoActividad = explode(",", $type);
// 		}

// 		$select = '<select class="form-select form-control-sm" name="' . $name . '" id="slct_' . $name . '_' . $id . '">';
// 		$select .= '<option value="" disabled selected>Seleccione</option>';

// 		foreach ($arrayTipoActividad as $value) {
// 			$selected = ($value == $value_select) ? ' selected' : '';
// 			$select .= '<option value="' . $value . '"' . $selected . '>' . $value . '</option>';
// 		}
// 		$select .= '</select>';
...
// 	// {
// 	// 	$sql = "SHOW COLUMNS FROM cmx_clientes  LIKE 'regimen'";
// 	// 	$result = $this->_db->getConsulta($sql);
...
// 	// 		$arrayTipoActividad = explode(",", $value["Type"]);
// 	// 	}
// 	// 	$select = '<select class="form-select form-select-sm select2 select2-hidden-accessible" name="' . $name . '" id="slct_' . $name . '_' . $id . '" aria-hidden="true">';
// 	// 	$select .= '<option value="" selected>Seleccione</option>';
// 	// 	foreach ($arrayTipoActividad as $key => $value) {
// 	// 		if ($value == $value_select) {
// 	// 			$select .= '<option value="' . $value . '" selected="">' . $value . '</option>';
...
// 	// 		$arrayTipoActividad = explode(",", $value["Type"]);
// 	// 	}
// 	// 	$select = '<select class="form-select form-select-sm" name="' . $name . '" id="slct_' . $name . '_' . $id . '" aria-hidden="true">';
// 	// 	$select .= '<option value="" disabled selected>Seleccione</option>';
// 	// 	foreach ($arrayTipoActividad as $key => $value) {
// 	// 		if ($value == $value_select) {
// 	// 			$select .= '<option value="' . $value . '" selected="">' . $value . '</option>';
...
// 	// 		$arrayTipoActividad = explode(",", $value["Type"]);
// 	// 	}
// 	// 	$select = '<select class="form-select form-select-sm" name="' . $name . '" id="slct_' . $name . '_' . $id . '">';
// 	// 	$select .= '<option value="" disabled selected>Seleccione</option>';
// 	// 	foreach ($arrayTipoActividad as $key => $value) {
// 	// 		if ($value == $value_select) {
// 	// 			$select .= '<option value="' . $value . '" selected="">' . $value . '</option>';
...
// 	public function getEnumSlctTipoCuenta_sm($name, $id, $value_select)
// 	{
// 		$sql = "SHOW COLUMNS FROM cmx_clientes_bancos LIKE 'tipo_cuenta'";
// 		$stmt = $this->_db3->prepare($sql);
// 		$stmt->execute();
// 		$result = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
// 	public function getEnumSlctTipoSociedad_sm($name, $id, $value_select)
// 	{
// 		$sql = "SHOW COLUMNS FROM cmx_clientes LIKE 'tipo_sociedad'";
// 		$stmt = $this->_db3->prepare($sql);
// 		$stmt->execute();
// 		$result = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
// 	public function getEnumSlctCifinCalificacion_sm($name, $id, $value_select)
// 	{
// 		$sql = "SHOW COLUMNS FROM cmx_clientes_cifin LIKE 'calificacion'";
// 		$stmt = $this->_db3->prepare($sql);
// 		$stmt->execute();
// 		$result = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
// 		$select = '<select class="form-select form-select-sm" id="slct_sede_otributaria">';
// 		$select .= '<option value="" disabled selected>Seleccione</option>';

// 		foreach ($result as $value) {
// 			$select .= '<option value="' . htmlspecialchars($value['id']) . '">'
// 				. htmlspecialchars($value['codigo']) . ' '
// 				. htmlspecialchars($value['descripcion']) . '</option>';
// 		}
...
// 		$select = '<select class="form-select form-select-sm" id="slct_cliente_empresa">';
// 		$select .= '<option value="" disabled selected>Seleccione</option>';

// 		foreach ($result as $value) {
// 			$select .= '<option value="' . htmlspecialchars($value['id']) . '">'
// 				. htmlspecialchars($value['cod_empresa']) . ' '
// 				. htmlspecialchars($value['nombre_empresa']) . '</option>';
// 		}
