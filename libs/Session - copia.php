    ...
    public function campana_notificaciones()
    {
        ...
        if ($total == 0) {
            ...
            while ($datos_actividades = $consulta->fetch()) {
                $this->listado[] = $datos_actividades;
            }
        }
    }
        ...
        if ($total == 0) {
            ...
            while ($datos_actividades = $consulta->fetch()) {
                ...
                if ($datos_actividades['diferencia'] >= $datos_actividades['diferencia_restante']) {
                    $this->listado[] = $datos_actividades;
                    if ($x == 1) {
                        // $sql = "SELECT id FROM cmx_ordenes_compra "
                        //     . "WHERE cs_num_de_orden= :cs_num_de_orden";
                        ...
                        while ($ordenes = $consultaordenes->fetch()) {
                            // $sql = "UPDATE cmx_actividades_carga_oc "
                            //     . "SET notificado = '1' "
                            //     . "WHERE nombre= :nombre AND id_carga = :id_carga";
