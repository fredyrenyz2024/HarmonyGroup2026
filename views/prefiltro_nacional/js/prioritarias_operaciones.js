...
$(document).ready(function () {
  ...
  window.initScript = function (id) {
    ...
    //         if (data) {
    //           data.result.forEach(function (element, index) {
    //             // var btn = '<button id="btn_' + element.id_preestudio +
    //             //   '" class="btn btn-xs btn-secondary" onClick="Historial_estado(this)"  data-id="' + element
    //             //   .id_preestudio + '">Historial</button>';
...
//                 <td>${cliente}</td>
//                 <td>
//                     <input type="text" id="fl${num}" class="form-control form-control-sm tflete"
//                         value="${flete}" readonly="readonly"
//                         onChange="javascript:currencyMask(this)">
//                 </td>
//                 <td style="display:none">
//                     <input type="text" class="form-control form-control-sm tneto2"
//                         value="${pesoneto}" readonly="readonly">
//                 </td>
//                 <td>
//                     <input type="hidden" id="tari${num}" class="form-control form-control-sm ttarifa"
//                         value="${tarifa}" readonly="readonly">
//                 </td>
//                 <td>${tipo_servicio}</td>
//             </tr>
//         `);
...
//           <tr>
//               <td>
//                   <input type="text" id="totalfle" class="form-control form-control-sm"
//                       value="${flete}" readonly="readonly">
//               </td>
//               <td style="display:none;">
//                   <input type="text" id="totalneto" class="form-control form-control-sm"
//                       value="${pesoneto}" readonly="readonly">
//               </td>
//               <td>
//                   <input type="hidden" id="tottarifa" class="form-control form-control-sm"
//                       value="${tarifa}" readonly="readonly">
//               </td>
//           </tr>
//       `);
