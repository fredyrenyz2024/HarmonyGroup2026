...
function preestudio(element) {
    ...
    <div class="row" id="divdatos">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div id="accordion1" class="panel-group accordion">
          <!-- Acordeon Itr -->
          <div class="accordion hello" id="datos_proveedores" style="display:none;">
                <div class="accordion-item border-top">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><i class="icon mdi mdi-chevron-down"></i>Datos ITR</button>
                    </h2>
                </div>
    ...
    <div class="offcanvas-footer p-3 border-top text-center">
      <div class="d-flex justify-content-end align-content-between gap-3">
        ...
        <button id="crear_preestudio" class="btn btn-success btn-sm me-1 my-0" data-escenarioId='${escenario}'><i class="far fa-save"></i> Guardar Prefiltro</button>
      </div>
    </div>
    `);
...
$(document).on('click', '#btn_soli', function () {
    // $('#solicitudservicio').modal('show');
...
//                         // Bloque de solicitud (antes era un <tr>)
...
//                             </div>
//                         `);
//                         // Mantener los valores de conteo
//                         $("#maxservi").val(cone);
//                         $("#maxservi2").val(cone);
                ...
                if (document.getElementById('placa').value !== '') {
                    ...
                    if (result.isConfirmed) {
                        ...
                        if (!msg_error && $('#estado_prefiltron').val() == '') {
                                        ...
                                        .then(function (datas) {
                                            if (datas) {
                                                ...
                                                Swal.fire({
                                                    ...
                                                    html: datas || 'La solicitud fue guardada exitosamente.',
                                                    icon: 'success',
                                                ...
                                                Filtro();
                                                // Ocultar el offcanvas automáticamente
                            ...
                            // alert("HOLA MUNDO DESDE ESTE LADO 1");
                                        ...
                                        await fetch($('#base_url').val() + 'validacionparametros/Insert_estudio_itr_subasta', {
                                            ...
                                            .then(function (data) {
                                                if (data.numero === 200) {
                                                    ...
                                                    Swal.fire({
                                                        title: 'Solicitud Guardada',
                                                        html: data.mensaje || 'La solicitud fue guardada exitosamente.',
                                                        icon: 'success',
                                                        confirmButtonColor: '#3B71CA',
                                                        customClass: {
                                                            popup: 'swal2-custom-font',
            ...
            if (document.getElementById('placa').value !== '') {
                ...
                if (result.isConfirmed) {
                    ...
                    if (!msg_error && $('#estado_prefiltron').val() == '') {
                        ...
                        // alert("HOLA MUNDO DESDE ESTE LADO 4");
                        // Convierte el HTML en una lista de textos por <p>
                        const tempDiv = document.createElement('div');
                        tempDiv.innerHTML = msg_error;
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="password" id="fl${element.numer_solservicio}" 
                                        ...
                                        value="${element.flete}" readonly onchange="javascript:currencyMask(this)">
                                </div>
                                <div class="col-md-4" style="display:none;">
                                    <label class="form-label">Peso Neto</label>
                        ...
                        <div id="fil1" class="border rounded p-3 mb-3 bg-light ${element.cod_ini_ruta}">
                            <div class="row mb-2">
                                <div class="col-md-3">
                                    ...
                                    <input type="hidden" id="oculto${cont}" value="${cant}" class="form-control form-control-sm fo" disabled>
                                    <input type="text" id="serv${cont}" class="form-control form-control-sm fserv" value="${element.cod_ini_ruta}" disabled>
                                </div>

                                <div class="col-md-3">
                                    <label class="form-label">Fecha y Hora Estimada</label>
                                    <input type="text" id="fecha${cont}" class="form-control form-control-sm cp" 
                                        value="${element.fecha_estimada_entrega} ${element.hora_estimada}" disabled>
                                </div>

                                <div class="col-md-3">
                                    <label class="form-label">Peso</label>
                                    <input type="text" id="peso${cont}" class="form-control form-control-sm fp" value="${element.peso}" disabled>
                                </div>
                            </div>
