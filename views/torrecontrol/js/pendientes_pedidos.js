...
window.initScript = function (id) {
  ...
  listar_pedidos_pendientes(fechaColombia, fechaColombia);
  ...
  document.addEventListener("click", async (e) => {
    ...
    if (e.target.matches(`#campo-${window.VENTANA}-buscar`) || e.target.matches(`#campo-${window.VENTANA}-buscar *`)) {
      ...
      listar_pedidos_pendientes(fecha_inicial, fecha_final);
    }
...
async function listar_pedidos_pendientes(fecha_inicial, fecha_final) {
