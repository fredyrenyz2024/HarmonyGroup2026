...
async function listar_pedidos_proveedor(fecha_inicial, fecha_final) {
  ...
  dato.append('cliente_id', document.getElementById("cliente_id").value);
  ...
  try {
    ...
    if (data) {
      ...
      data.forEach(element => {
        ...
        if (element.estado_publicaion === 'Pendiente') {
        ...
        } else if (element.estado_publicaion === 'Iniciado') {
          ...
          col_estatus_publicacion = ` <span class="badge badge-phoenix fs-10 badge-phoenix-danger"><span class="badge-label">${element.estado_publicaion}</span><span class="ms-1" data-feather="plus" style="height:12.8px;width:12.8px;"></span></span>`;
        ...
        } else if (element.estado_publicaion === 'Rechazado') {
          col_estatus_publicacion = `<span class="badge badge-phoenix fs-10 badge-phoenix-danger"><span class="badge-label">${element.estado_publicaion}</span><span class="ms-1" data-feather="plus" style="height:12.8px;width:12.8px;"></span></span>`;
        }
