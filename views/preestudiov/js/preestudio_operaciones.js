...
// const radioButtons = d.getElementById("prefiltro_seguridad");
...
d.addEventListener('DOMContentLoaded', async e => {
  ...
  d.addEventListener('click', async e => {
    ...
    //   let data = new FormData();
    //   data.append('propietario', propietario_id);
    //   data.append('tenedor', tenedor_id);
    //   data.append('conductor', conductor_id);
    //   data.append('placa', placa_id);
    //   await fetch($('#id_url_ajax').val() + 'validacionparametros/validar_hojas_vida', {
    //     method: 'POST',
    //     cache: 'no-cache',
    //     body: data,
    //   })
    ...
    //     await Hojas_de_vida(placa_id, conductor_id, propietario_id, tenedor_id);
    //   } catch (error) {
...
async function Hojas_de_vida(placas, conductor, propietario, tenedor, propietario_trailer, trailer) {
  //validar placa
  var fila = '';
