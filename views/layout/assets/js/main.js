    ...
    function leftSidebarOffCanvas() {
      ...
      $(document).on("mousedown touchstart", function (e) {
        if (
          ...
          !$(e.target).closest(config.toggleLeftSidebarButton).length &&
...
(FastClick.prototype.needsClick = function (a) {
  ...
  (FastClick.prototype.onTouchEnd = function (a) {
    ...
    if (
      ...
      return a.timeStamp - c > 100 || (deviceIsIOS && window.top !== window && "input" === d)
        ...
        : (this.focus(g), this.sendClick(g, a), (deviceIsIOS && "select" === d) || ((this.targetElement = null), a.preventDefault()), !1);
    return (
      !(!deviceIsIOS || deviceIsIOS4 || ((e = g.fastClickScrollParent), !e || e.fastClickLastScrollTop === e.scrollTop)) ||
  ...
  (FastClick.prototype.onClick = function (a) {
    ...
    return this.trackingClick
      ...
      : ("submit" === a.target.type && 0 === a.detail) || ((b = this.onMouse(a)), b || (this.targetElement = null), b);
  }),
  ...
  (FastClick.notNeeded = function (a) {
    ...
    if (
      ...
      ((d = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/)), d[1] >= 10 && d[2] >= 3 && (b = document.querySelector("meta[name=viewport]")))
    ) {
      if (b.content.indexOf("user-scalable=no") !== -1) return !0;
...
!(function () {
  ...
  function inputToRGB(color) {
    var rgb = {r: 0, g: 0, b: 0},
      ...
      format = !1;
    return (
      "string" == typeof color && (color = stringInputToObject(color)),
      "object" == typeof color &&
        (color.hasOwnProperty("r") && color.hasOwnProperty("g") && color.hasOwnProperty("b")
          ? ((rgb = rgbToRgb(color.r, color.g, color.b)), (ok = !0), (format = "%" === String(color.r).substr(-1) ? "prgb" : "rgb"))
  ...
  function hslToRgb(h, s, l) {
    function hue2rgb(p, q, t) {
      return 0 > t && (t += 1), t > 1 && (t -= 1), 1 / 6 > t ? p + 6 * (q - p) * t : 0.5 > t ? q : 2 / 3 > t ? p + 6 * (q - p) * (2 / 3 - t) : p;
    }
    var r, g, b;
  ...
  (tinycolor.prototype = {
    ...
    getLuminance: function () {
      ...
      return (
        ...
        (GsRGB = rgb.g / 255),
        (BsRGB = rgb.b / 255),
        (R = 0.03928 >= RsRGB ? RsRGB / 12.92 : Math.pow((RsRGB + 0.055) / 1.055, 2.4)),
        (G = 0.03928 >= GsRGB ? GsRGB / 12.92 : Math.pow((GsRGB + 0.055) / 1.055, 2.4)),
        (B = 0.03928 >= BsRGB ? BsRGB / 12.92 : Math.pow((BsRGB + 0.055) / 1.055, 2.4)),
    ...
    (tinycolor.mix = function (color1, color2, amount) {
      ...
      var w2 = 1 - w1,
        rgba = {r: rgb2.r * w1 + rgb1.r * w2, g: rgb2.g * w1 + rgb1.g * w2, b: rgb2.b * w1 + rgb1.b * w2, a: rgb2.a * p + rgb1.a * (1 - p)};
    ...
    (tinycolor.mostReadable = function (baseColor, colorList, args) {
      ...
      return tinycolor.isReadable(baseColor, bestColor, {level: level, size: size}) || !includeFallbackColors
        ? bestColor
