			...
			<head>
				...
				<style>
					...
					.se-pre-con {
						...
						height: 100%;
						z-index: 9999;
						background: url(%land_page%public/img/nexos_loading.gif) center no-repeat #fdfdfd;
					...
					<nav class="navbar navbar-default navbar-fixed-top be-top-header">
						<div class="container-fluid">
							...
							<div class="be-right-navbar">
								...
								<div class="page-title"><span>%titulo_modulo% ' . $this->titulo . '</span></div>
		...
		if (isset($_layoutParams['menu'])) {
			...
			foreach ($_layoutParams['menu'] as $key => $value) {
				...
				foreach ($value as $key1 => $value1) {
					...
					$menu .= '<li ' . $_activo . '><a href="' . $value1["enlace"] . '/' . $value1["metodo"] . '/">' . $value1["titulo"] . '</a></li>';
					$_activo = "";
				}
