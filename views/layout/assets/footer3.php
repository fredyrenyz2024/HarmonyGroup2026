<?php
	$vista = '
         ...
         <div class="footer navbar-fixed-bottom">
		   <div class="row" style="height:25px;background-color:#2BBBAD;margin:0px;color:white;padding:5px;
		   text-align:center;font-size:10pt">
		    <div class="col-lg-12">
		    	<span> Nexos Group S.a.S / Bogota - Colombia / Logistica - Almacenamiento - Transporte de Carga Multimodal / Nacional e Internacional
		    	</span>
		    </div>
		   </div>
	    <div>  
