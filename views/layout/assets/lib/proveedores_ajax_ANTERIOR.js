$(document).ready(function() {
	...
	$("#pv_tiposervice").change(function(){
		...
		if(tipo_service==''){
			...
			if(tipo_service=='Adecuaciones' || tipo_service=='Aduana' || tipo_service=='Impuestos'
				|| tipo_service=='Tramites operativos'){
				//limpiar campos
				$("#pv_via").val('');
				$("#pv_select").html('');
				$("#detalle_porteador").val('');
	...
	$("#pv_via").change(function(){
		...
		if(via=='Aerea'){
			$("#pv_select").html('<option value="Aerolinea de carga/pasajeros">Aerolinea de carga/pasajeros</option>'+
		...
		if(via=='Maritima'){
			$("#pv_select").html('<option value="Navieras">Navieras</option>'+
				'<option value="Agentes maritimos">Agentes maritimos</option>');
		}

		if(via=='Terrestre'){
			$("#pv_select").html('<option value="Transportadores terrestres">Transportadores terrestres</option>'+
	...
	function agregar_contacto(){
		...
		var contace='<tr>'+
				...
				'<td colspan="2" class="info"><label>N°</label><p class="text-center text-primary"><strong>'+a+'</strong></p><input type="hidden" id="sk'+a+'" value="1" class="form-control input-sm">  </td>'+
				'</tr><tr>'+	
				'<td colspan="2"><label>Nombres</label> <input type="text" id="nombres'+a+'" class="form-control input-sm"></td>'+
				'</tr><tr>'+	
				'<td><label>Cargo</label> <input type="text" id="cargo'+a+'" class="form-control input-xs"></td>'+
				'<td><label>Teléfono</label> <input type="number" id="fijo'+a+'" class="form-control input-xs"></td>'+
				'<tr>'+
				'<td><label>Celular</label> <input type="number" id="celular'+a+'" class="form-control input-xs">  </td>'+
				'<td><label>Correo</label>   <input type="email" id="correo'+a+'" class="form-control input-xs" > </td>'+
				'</tr>'+
				'<tr>'+
				'<td><label>Info. crítica</label> <textarea id="critica'+a+'" class="form-control input-xs"></textarea>   </td>'+
				'<td><label>Referencia</label> <textarea id="refe'+a+'" class="form-control input-xs"></textarea>  </td>'+
				'</tr>'+
			'</tr>';
	...
	if (!msg_error) {
		...
		if($("#Conductor").is(':checked')){
			...
			for(var s=0; s< acuerdo1.length; s++){
				data.append("acuerdo_uno"+ s, acuerdo1[s]);
			}
		...
		if( $("#Conductor").is(':checked')) {
			...
			//acuerdos
			data.append("name_a1", $("#name_a1").val());
		}


		if($("#Proveedor").is(':checked')) {
			data.append("tipo_proveedor", $(".tipo_proveedor").val());
			data.append("nacional", $("#nacional").is(':checked'));
			data.append("internacional", $("#internacional").is(':checked'));
			data.append("pv_localizacion", $("#pv_localizacion").val());
			data.append("pv_zona", $("#pv_zona").val());
			data.append("pv_tiposervice", $("#pv_tiposervice").val());
			data.append("pv_via", $("#pv_via").val());
			data.append("pv_select", $("#pv_select").val());
			data.append("detalle_porteador", $("#detalle_porteador").val());
			data.append("detalle_acarga", $("#detalle_acarga").val());
			data.append("tramite_ad", $("#tramite_ad").val());
			data.append("verifica", '');
			data.append("una", 1);
		}	
...
function tipo_service(){
	...
	if(tp=='Transporte'){
		$("#edetalle1").html('<option value="Aerea">Aerea</option>'+
			'<option value="Maritima">Maritima</option>'+
			'<option value="Terrestre">Terrestre</option>');
	}

	if(tp=='Porteadores'){
		$("#edetalle1").html('<option value="Puertos">Puertos</option>'+
	...
	if(tp=='Agenciamiento de carga'){
		$("#edetalle1").html('<option value="Agentes de carga">Agentes de carga</option>'+
			'<option value="Consolidador neutral">Consolidador neutral</option>'
		);
	}

	if(tp=='Tramites administrativocs'){
		$("#edetalle1").html('<option value="Navidad">Navidad</option>'+
	 				...
	 				if(data.result){
						...
						$("#e_fecha_nacimiento").val(data.result[0].fecha_nacimiento);
						 ...
						 if(s=='' || s==null || s=='SIN REGISTRAR'){
						 	$("#e_sexo").html('<option value="SIN REGISTRAR">SIN REGISTRAR</option>'+
						 		'<option value="Femenino">Femenino</option>'+
						 		'<option value="Masculino">Masculino</option>');
						 }
						 if(s=='Femenino'){
						 ...
						 if(sangre=='' || sangre==null || sangre=='SIN REGISTRAR'){
						 	 $("#e_sangre").html('<option value="SIN REGISTRAR">SIN REGISTRAR</option>'+
						 	 	'<option value="O+">O+</option>'+
						 	 	'<option value="O-">O-</option>'+
								'<option value="A+">A+</option>'+
								'<option value="A-">A-</option>'+
						...
						if(civil=='' || civil==null || civil==0){
							$("#e_civil").html('<option value="0">SIN REGISTRAR</option>'+
						...
						if(data.result3){
							...
							data.result3.forEach(function(element,index){
								...
								if(pare=='' || pare==null || pare==0){
									$("#e_parenp"+contp).html('<option value="0">Sin registrar</option>'+
						...
						if(data.result6){
							...
							if(tp==2){
							 ...
							 data.result6[0].id_municipio.forEach(function(element,index){
				 				...
				 				var municipio=$('#e_localizacion').append('<option '+tmpSelected+' value="'+element.munid+'">'+element.munmun+'-'+element.mundepto+'-'+element.munpais+'</option>');
							 });

							$("#e_zona").val(data.result6[0].descripcion_zona);
							var ts=data.result6[0].tipo_servicio;
							$("#e_tiposervicio").html('<option value="'+ts+'">'+ts+'</option>'+
							...
							if(ts=='Porteadores' && du=='Puertos'){
								...
								$("#edetalle1").html('<option value="'+du+'">'+du+'</option>'+
									'<option value="Aeropuertos">Aeropuertos</option>'+
									'<option value="Entes regulatorios">Entes regulatorios</option>'+
									'<option value="Tramites en frontera">Trámites en frontera</option>');
								$("#edetalle2").html('<option value="'+dd+'">'+dd+'</option>');	
							...
							if(ts=='Transporte' && du=='Maritima'){
								...
								if(dd=='Navieras'){
									$("#edetalle2").html('<option value="Navieras">Navieras</option>'+
										'<option value="Agentes maritimos">Agentes maritimos</option>');
								}
							...
							if(dd=='Transportadores terrestres'){
								$("#edetalle2").html('<option value="Transportadores terrestres">Transportadores terrestres</option>'+
									'<option value="Nacionales">Nacionales</option>'+
									'<option value="Transportadores urbanos">Transportadores urbanos</option>');
							}
						...
						if(data.result7){
							...
							data.result7.forEach(function(element,index){
								...
								var tabla="<tr class='tr"+cont+"'  > "+
									"<th class='tr"+cont+"'>Id</th><th class='tr"+cont+"'>Nombre</th><th class='tr"+cont+"'>Cargo</th></tr>"+
									"<tr class='tr"+cont+"'><td class='tr"+cont+"' > <input type='text' id='idtb"+cont+"' value="+element.id+" disabled='disabled'>   </td> "+
									"<td> <input type='text' id='enombre"+cont+"' class='form-control input-sm tr"+cont+"'  value="+element.nombres_apellidos+"  > </td>"+
									"<td> <input type='text' id='ecargo"+cont+"' class='form-control input-sm tr"+cont+"' value="+element.cargo+"  > </td>"+
									"</tr><tr class='tr"+cont+"'>"+
									"<th class='tr"+cont+"'>Teléfono</th><th class='tr"+cont+"'>Celular</th>"+
									"</tr><tr class='tr"+cont+"'>"+
									"<td> <input type='number' id='etelefono"+cont+"' class='form-control input-sm tr"+cont+"' value="+element.telefono+" >  </td>"+
									"<td> <input type='number' id='ecelu"+cont+"' class='form-control input-sm tr"+cont+"' value="+element.celular+" >  </td>"+
									"</tr><tr class='tr"+cont+"'>"+
									"<th class='tr"+cont+"'>Correo</th><th class='tr"+cont+"'>Critica</th>"+
									"</tr><tr class='tr"+cont+"'>"+
									"<td> <input type='text' id='ecorreo"+cont+"' class='form-control input-sm tr"+cont+"' value="+element.correo+">  </td>"+
									"<td> <input type='text' id='ecriti"+cont+"' class='form-control input-sm tr"+cont+"' value="+element.inf_critica+"  >  </td>"+
									"</tr><tr class='tr"+cont+"'>"+
									"<th class='tr"+cont+"'>Referencia</th>"+
									"<td colspan='2'> <input type='text' id='erefe"+cont+"' class='form-control input-sm tr"+cont+"'  value="+element.referencias+" > </td>"+
									'<td class="tr'+cont+'">'+ch+'<input type="hidden" id="sy'+cont+'" value="1"></td>'
								+"</tr>";
						...
						if(data.result[0].name_acuerdo1!='' && data.result[0].name_acuerdo1!=null){
							...
							docu='<a  href="http://localhost/mvcLuisMiguel/'+data.result[0].foto_acuerdo1+'/'+data.result[0].name_acuerdo1+'"  target="_blank" class="cell-detail hint--top-left" data-hint="">'+
									'<span class="icon mdi mdi-file-text data-toggle="modal" title="Documento" >'+
									'</span>'+
								'</a>';
								$("#acuerdo1").html(docu);
						...
						if(data.result[0].name_acuerdo2!='' && data.result[0].name_acuerdo2!=null){
							...
							docu='<a  href="http://localhost/mvcLuisMiguel/'+data.result[0].foto_acuerdo2+'/'+data.result[0].name_acuerdo2+'"  target="_blank" class="cell-detail hint--top-left" data-hint="">'+
									'<span class="icon mdi mdi-file-text data-toggle="modal" title="Documento" >'+
									'</span>'+
								'</a>';
								$("#acuerdo2").html(docu);
						...
						if(data.result[0].name_acuerdo3!='' && data.result[0].name_acuerdo3!=null){
							...
							docu='<a  href="http://localhost/mvcLuisMiguel/'+data.result[0].foto_acuerdo3+'/'+data.result[0].name_acuerdo3+'"  target="_blank" class="cell-detail hint--top-left" data-hint="">'+
									'<span class="icon mdi mdi-file-text data-toggle="modal" title="Documento" >'+
									'</span>'+
								'</a>';
								$("#acuerdo3").html(docu);
						...
						if(data.result[0].name_acuerdo4!='' && data.result[0].name_acuerdo4!=null){
							...
							docu='<a  href="http://localhost/mvcLuisMiguel/'+data.result[0].foto_acuerdo4+'/'+data.result[0].name_acuerdo4+'"  target="_blank" class="cell-detail hint--top-left" data-hint="">'+
									'<span class="icon mdi mdi-file-text data-toggle="modal" title="Documento" >'+
									'</span>'+
								'</a>';
								$("#acuerdo4").html(docu);
						...
						if(data.result[0].documentos_soporte!='' && data.result[0].documentos_soporte!=null){
							...
							docu='<a  href="http://localhost/mvcLuisMiguel/'+data.result[0].documentos_soporte+'"  target="_blank" class="cell-detail hint--top-left" data-hint="">'+
									'<span class="icon mdi mdi-file-text data-toggle="modal" title="Documento" >'+
									'</span>'+
								'</a>';
...
$(document).on('click','.borrar2',function(event){
	...
	function agregar_contactom(){
		...
		var contace='<tr class="trc'+m+'">'+
				//'<th>#</th><th>Nombres</th><th>Cargo</th><th>Teléfono</th></tr><tr>'+
				'<td colspan="2" class="info trc'+m+'" ><label>N°</label><p class="text-center text-primary"><strong>'+m+'</strong></p><input type="hidden" id="sk'+m+'" value="1" class="form-control input-sm">  </td>'+
				'</tr><tr class="trc'+m+'">'+	
				'<td colspan="2" class="trc'+m+'"><label>Nombres</label> <input type="text" id="nombres'+m+'" class="form-control input-sm trc'+m+'"></td>'+
				'</tr><tr class="trc'+m+'">'+	
				'<td class="trc'+m+'"><label>Cargo</label> <input type="text" id="cargo'+m+'" class="form-control input-xs trc'+m+'"></td>'+
				'<td class="trc'+m+'"><label>Teléfono</label> <input type="number" id="fijo'+m+'" class="form-control input-xs trc'+m+'"></td>'+
				'<tr class="trc'+m+'">'+
				'<td class="trc'+m+'"><label>Celular</label> <input type="number" id="celular'+m+'" class="form-control input-xs trc'+m+'">  </td>'+
				'<td class="trc'+m+'"><label>Correo</label>   <input type="email" id="correo'+m+'" class="form-control input-xs trc'+m+'" > </td>'+
				'</tr>'+
				'<tr class="trc'+m+'">'+
				'<td class="trc'+m+'"><label>Info. crítica</label> <textarea id="critica'+m+'" class="form-control input-xs trc'+m+'"></textarea>   </td>'+
				'<td class="trc'+m+'"><label>Referencia</label> <textarea id="refe'+m+'" class="form-control input-xs trc'+m+'"></textarea>  </td>'+
				'</tr>'+
				'<tr class="trc'+m+'"><td colspan="2">'+ch+'</td></tr>'+
			'</tr>';
	 					...
	 					if(data.resultb!=null){
	 						data.resultb.forEach(function(element,index){
	 							$("#tcontactos").append('<tr>'+
	 								'<td>'+element.nombres_apellidos+'</td>'+
	 								'<td>'+element.cargo+'</td>'+
	 								'<td>'+element.telefono+'</td>'+
	 								'<td>'+element.celular+'</td>'+
	 								'<td>'+element.correo+'</td>'+
	 								'<td>'+element.inf_critica+'</td>'+
	 								'<td>'+element.referencias+'</td>'+
	 								+'</tr>');
	 						});
	 					}
