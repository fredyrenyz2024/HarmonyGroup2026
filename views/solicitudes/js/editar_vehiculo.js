...
d.addEventListener('DOMContentLoaded', async e => {
  ...
  var numVehiculo = params.get('num_vehiculo');
  ...
  /* LLenar el formulario con todos los datos ya registrados en la base de datos */

  // $('#loading-overlay-nexosapp ').css('display', 'flex'); // Mostrar mensaje de carga
  let formdata = new FormData();
  formdata.append('id_vehiculo', decodificarBase64(numVehiculo));
  try {
    const response = await fetch($('#id_url_ajax').val() + 'vehiculos/traer_datos_vehiculo', {
      method: 'POST',
      body: formdata,
      cache: 'no-cache',
    });
    ...
    if (data) {
      // alert(data.Resultados[0].clase_vehiculo);

      d.getElementById('form_edit').style.display = 'block';
      d.getElementById('mensaje_error_bd').style.display = 'none';
      // console.log(data);
      d.getElementById('placa').value = data.Resultados[0].placa;
      d.getElementById('placa').disabled = true;
      d.getElementById('web_satelital').value = data.Resultados[0].web_satelital;
      d.getElementById('usuario_satelital').value = data.Resultados[0].usuario_satelital;
      d.getElementById('clave_satelital').value = data.Resultados[0].clave_satelital;
      d.getElementById('tipo_combustible').value = data.Resultados[0].cod_tipo_combustible;
      d.getElementById('num_motor').value = data.Resultados[0].num_motor;
      d.getElementById('num_chasis').value = data.Resultados[0].num_chasis;
      d.getElementById('repotencia').value = data.Resultados[0].repotenciado;
      console.log('🚀 ~ data.Resultados[0].repotenciado:', data.Resultados[0].repotenciado);
      if (data.Resultados[0].repotenciado === 1) {
        document.getElementById('campo_repotenciado').style.display = 'block';
        d.getElementById('repotenciado').value = data.Resultados[0].repotenciado;
      } else {
        document.getElementById('campo_repotenciado').style.display = 'none';
      }
      d.getElementById('numero_poliza').value = data.Resultados[0].num_soat;
      d.getElementById('soat_vencimiento').value = data.Resultados[0].vence_soat;
      d.getElementById('tipovinculacion').value = data.Resultados[0].tipo_vinculacion;
      d.getElementById('lice_transito').value = data.Resultados[0].licencia_transito;
      d.getElementById('cant_viaje').value = data.Resultados[0].cant_viajes;
      d.getElementById('capacidad_tn').value = data.Resultados[0].capacidad_tn;
      d.getElementById('peso_bruto').value = data.Resultados[0].pesobruto_kg;
      d.getElementById('peso_vacio').value = data.Resultados[0].peso;
      /* Configuracion */
      d.getElementById('configuracion').value = data.Resultados[0].v_confi;
      d.getElementById('id_vehiculo_configuracion').value = data.Resultados[0].config_id;
      d.getElementById('rndc_vehiculo_configuracion').value = data.Resultados[0].Col_Rncd_id;
      d.getElementById('rndc_sigla').value = data.Resultados[0].v_confi;

      /* Trailer */
      if (
        data.Resultados[0].v_confi == 2 ||
        data.Resultados[0].v_confi == 3 ||
        data.Resultados[0].v_confi == 4 ||
        data.Resultados[0].v_confi == 'CA' ||
        data.Resultados[0].v_confi == 'V2' ||
        data.Resultados[0].v_confi == 'V3' ||
        data.Resultados[0].v_confi == 'V4'
      ) {
        $('#trailers').html('<option value="NA">No Aplica</option>');
      } else {
        data.resultados_configuracion_completa.forEach(element => {
          $('#trailers').append('<option value="' + element.id + '">' + element.placa + ' (' + element.nombre + ' ' + element.descripcion + ')</option>');
        });
        d.getElementById('trailers').value = data.Resultados[0].Trailer;
        d.getElementById('trailer_anterior').value = data.Resultados[0].Trailer;
      }
      d.getElementById('marca').value = data.Resultados[0].marca;
      /* Colocar las lineas */
      data.resultados_lineas.forEach(element => {
        $('#linea').append('<option value="' + element.id + '">' + element.descripcion + '</option>');
      });

      /* Color */
      d.getElementById('color_tabla').value = data.Resultados[0].color;
      d.getElementById('id_vehiculo_color').value = data.Resultados[0].Color_id;
      d.getElementById('rndc_vehiculo_color').value = data.Resultados[0].rndc_id;
      d.getElementById('color').value = data.Resultados[0].Color_id;

      d.getElementById('linea').value = data.Resultados[0].linea;
      d.getElementById('modelo').value = data.Resultados[0].anio_fabricacion;
      d.getElementById('f_matricula').value = data.Resultados[0].f_matricula;
      d.getElementById('clase_v').value = data.Resultados[0].clase_vehiculo;
      d.getElementById('tipo_carroceria').value = data.Resultados[0].tipo_carroceria;

      /* Datos de tecnomecanica */
      d.getElementById('tecnomecanica').value = data.Resultados[0].tecnomecanica;
      d.getElementById('fecha_tecno').value = data.Resultados[0].tecno_fecha_expedida;
      d.getElementById('fecha_vig_tecno').value = data.Resultados[0].tecno_fecha_vigencia;
      /* Poliza */
      d.getElementById('numero_polizaRC').value = data.Resultados[0].poliza_responsabilidad !== 'undefined' ? data.Resultados[0].poliza_responsabilidad : '';
      d.getElementById('fecha_poliza').value = data.Resultados[0].vence_poliza;
      /*Aseguradora*/
      d.getElementById('aseguradora_tabla').value = data.Resultados[0].Aseguradora;
      d.getElementById('id_vehiculo_aseguradora').value = data.Resultados[0].Aseg_id;
      d.getElementById('rndc_vehiculo_aseguradora').value = data.Resultados[0].Aseg_Rdnc_id;
      /*Gps */
      d.getElementById('empresa_satelital').value = data.Resultados[0].empresa_gps;

      /* Fechas del preoperaciones */

      d.getElementById('fecha_expedicion_preoperacional').value = data.Resultados[0].fecha_expedicion_preoperacional;
      d.getElementById('fecha_vencimiento_preoperacional').value = data.Resultados[0].fecha_vencimiento_preoperacional;

      /* Fotos y documentos */
      if (data.Resultados[0].name_transito !== null && data.Resultados[0].name_transito !== '') {
        d.getElementById('img_licencia').innerHTML = `<button class="btn btn-primary btn-xs" style="width: 100%;height: 100%;" onclick="abrir_fotos('${data.Resultados[0].foto_transito}', '${data
          .Resultados[0].name_transito}')"><i class="fa-regular fa-image"></i></button>`;
      } else {
        d.getElementById('img_licencia').innerHTML = '<button class="btn btn-danger btn-xs" style="width: 100%;height: 100%;" diisabled><i class="fa-regular fa-image"></i></button>';
        d.getElementById('img_licencia').style.color = 'red';
        d.getElementById('img_licencia').style.textAlign = 'center';
      }

      /* Foto derecha */
      if (data.Resultados[0].name_derecha !== null && data.Resultados[0].name_derecha !== '') {
        d.getElementById('img_foto_derecha').innerHTML = `<button class="btn btn-primary btn-xs" style="width: 100%;height: 100%;" onclick="abrir_fotos('${data.Resultados[0].foto_derecha}', '${data
          .Resultados[0].name_derecha}')"><i class="fa-regular fa-image"></i></button>`;
      } else {
        d.getElementById('img_foto_derecha').innerHTML = '<button class="btn btn-danger btn-xs" style="width: 100%;height: 100%;" diisabled><i class="fa-regular fa-image"></i></button>';
        d.getElementById('img_foto_derecha').style.color = 'red';
        d.getElementById('img_foto_derecha').style.textAlign = 'center';
      }

      /* Soat */
      if (data.Resultados[0].name_soat !== null && data.Resultados[0].name_soat !== '') {
        d.getElementById('img_soat').innerHTML = `<button class="btn btn-primary btn-xs" style="width: 100%;height: 100%;" onclick="abrir_fotos('${data.Resultados[0].foto_soat}', '${data.Resultados[0]
          .name_soat}')"><i class="fa-regular fa-image"></i></button>`;
      } else {
        d.getElementById('img_soat').innerHTML = '<button class="btn btn-danger btn-xs" style="width: 100%;height: 100%;" diisabled><i class="fa-regular fa-image"></i></button>';
        d.getElementById('img_soat').style.color = 'red';
        d.getElementById('img_soat').style.textAlign = 'center';
      }

      /* Izquierda */
      if (data.Resultados[0].name_izquierda !== null && data.Resultados[0].name_izquierda !== '') {
        d.getElementById('img_foto_izquierda').innerHTML = `<button class="btn btn-primary btn-xs" style="width: 100%;height: 100%;" onclick="abrir_fotos('${data.Resultados[0]
          .foto_izquierda}', '${data.Resultados[0].name_izquierda}')"><i class="fa-regular fa-image"></i></button>`;
      } else {
        d.getElementById('img_foto_izquierda').innerHTML = '<button class="btn btn-danger btn-xs" style="width: 100%;height: 100%;" diisabled><i class="fa-regular fa-image"></i></button>';
        d.getElementById('img_foto_izquierda').style.color = 'red';
        d.getElementById('img_foto_izquierda').style.textAlign = 'center';
      }

      /* Tecnomecanica */
      if (data.Resultados[0].name_tecno !== null && data.Resultados[0].name_tecno !== '') {
        d.getElementById('name_tecno_edit').value = data.Resultados[0].name_tecno;
        d.getElementById('img_tecno_mecanica').innerHTML = `<button class="btn btn-primary btn-xs" style="width: 100%;height: 100%;" onclick="abrir_fotos('${data.Resultados[0].foto_tecno}', '${data
          .Resultados[0].name_tecno}')"><i class="fa-regular fa-image"></i></button>`;
      } else {
        d.getElementById('img_tecno_mecanica').innerHTML = '<button class="btn btn-danger btn-xs" style="width: 100%;height: 100%;" diisabled><i class="fa-regular fa-image"></i></button>';
        d.getElementById('img_tecno_mecanica').style.color = 'red';
        d.getElementById('img_tecno_mecanica').style.textAlign = 'center';
      }

      /* Foto vehiculo atras */
      if (data.Resultados[0].name_atras !== null && data.Resultados[0].name_atras !== '') {
        d.getElementById('img_vehiculo_atras').innerHTML = `<button class="btn btn-primary btn-xs" style="width: 100%;height: 100%;" onclick="abrir_fotos('${data.Resultados[0].foto_atras}', '${data
          .Resultados[0].name_atras}')"><i class="fa-regular fa-image"></i></button>`;
      } else {
        d.getElementById('img_vehiculo_atras').innerHTML = '<button class="btn btn-danger btn-xs" style="width: 100%;height: 100%;" diisabled><i class="fa-regular fa-image"></i></button>';
        d.getElementById('img_vehiculo_atras').style.color = 'red';
        d.getElementById('img_vehiculo_atras').style.textAlign = 'center';
      }

      /* Foto vehiculo frente */
      if (data.Resultados[0].name_frontal !== null && data.Resultados[0].name_frontal !== '') {
        d.getElementById('img_vehiculo_frente').innerHTML = `<button class="btn btn-primary btn-xs" style="width: 100%;height: 100%;" onclick="abrir_fotos('${data.Resultados[0]
          .foto_vehiculo}', '${data.Resultados[0].name_frontal}')"><i class="fa-regular fa-image"></i></button>`;
      } else {
        d.getElementById('img_vehiculo_frente').innerHTML = '<button class="btn btn-danger btn-xs" style="width: 100%;height: 100%;" diisabled><i class="fa-regular fa-image"></i></button>';
        d.getElementById('img_vehiculo_frente').style.color = 'red';
        d.getElementById('img_vehiculo_frente').style.textAlign = 'center';
        d.getElementById('existe_foto_frente').value = 'sin documento';
      }

      /* Documento kit mercancias peligrosas solo cuando exista */
      if (data.Resultados[0].nombre_kit !== null && data.Resultados[0].nombre_kit !== '') {
        d.getElementById('documento_kit_mercancia').innerHTML = `<button class="btn btn-primary btn-xs" style="width: 100%;height: 100%;" onclick="abrir_fotos('${data.Resultados[0]
          .documento_kit}', '${data.Resultados[0].nombre_kit}')"><i class="fa-regular fa-image"></i></button>`;
      } else {
        d.getElementById('documento_kit_mercancia').innerHTML = '<button class="btn btn-danger btn-xs" style="width: 100%;height: 100%;" diisabled><i class="fa-regular fa-image"></i></button>';
        d.getElementById('documento_kit_mercancia').style.color = 'red';
        d.getElementById('documento_kit_mercancia').style.textAlign = 'center';
      }
      /* Documento preoperacional */
      if (data.Resultados[0].nombre_preopeacional !== null && data.Resultados[0].nombre_preopeacional !== '') {
        d.getElementById('documento_preoperacional').innerHTML = `<button class="btn btn-primary btn-xs" style="width: 100%;height: 100%;" onclick="abrir_fotos('${data.Resultados[0]
          .documento_preopeacional}', '${data.Resultados[0].nombre_preopeacional}')"><i class="fa-regular fa-image"></i></button>`;
      } else {
        d.getElementById('documento_preoperacional').innerHTML = '<button class="btn btn-danger btn-xs" style="width: 100%;height: 100%;" diisabled><i class="fa-regular fa-image"></i></button>';
        d.getElementById('documento_preoperacional').style.color = 'red';
        d.getElementById('documento_preoperacional').style.textAlign = 'center';
        d.getElementById('existe_preoperacional').value = 'sin documento';
      }

      /* Proveedores de este Vehiculo */
      d.getElementById('propietario_tabla').value = data.Resultados[0].Propietario;
      d.getElementById('id_propietario').value = data.Resultados[0].id_propietario;
      d.getElementById('poseedor_tabla').value = data.Resultados[0].Poseedor;
      d.getElementById('id_tenedor').value = data.Resultados[0].id_tenedor;
      d.getElementById('conductor_tabla').value = data.Resultados[0].Conductor;
      d.getElementById('id_conductor').value = data.Resultados[0].id_conductor;
    } else {
      d.getElementById('form_edit').style.display = 'none';
    ...
    if (e.target.matches('#fecha_poliza') || e.target.matches('#fecha_poliza *')) {
      ...
      if (fechaActual.isAfter(fecha_vencimiento_poliza)) {
        ...
        <div class="alert alert-primary alert-icon alert-icon-border alert-dismissible" role="alert">
          ...
          <div class="message">
            <button class="close" type="button" data-dismiss="alert" aria-label="Close"><span class="mdi mdi-close" aria-hidden="true"></span></button><strong>Mensaje!</strong> Faltan <b>${diasRestantes}</b> dias, para que la Póliza venza.
          </div>
        </div>
      `;
      }
    ...
    if (e.target.matches('#soat_vencimiento') || e.target.matches('#soat_vencimiento *')) {
      ...
      if (fechaActual.isAfter(fecha_vencimiento_soat)) {
        ...
        <div class="alert alert-primary alert-icon alert-icon-border alert-dismissible" role="alert">
          <div class="icon"><span class="mdi mdi-info-outline"></span></div>
          <div class="message">
            <button class="close" type="button" data-dismiss="alert" aria-label="Close"><span class="mdi mdi-close" aria-hidden="true"></span></button><strong>Mensaje!</strong> Faltan <b>${diasRestantes}</b> dias, para que el soat venza.
          </div>
        </div>
      `;
      }
        ...
        fecha_vencimiento_tecnomecanica.addEventListener('change', async e => {
          ...
          if (fechaActual.isAfter(fecha_vencimiento_tecno)) {
            ...
            <div class="alert alert-primary alert-icon alert-icon-border alert-dismissible" role="alert">
              <div class="icon"><span class="mdi mdi-info-outline"></span></div>
              <div class="message">
                <button class="close" type="button" data-dismiss="alert" aria-label="Close"><span class="mdi mdi-close" aria-hidden="true"></span></button><strong>Mensaje!</strong> Faltan <b>${diasRestantes}</b> dias, para que la tecnomecanica venza.
              </div>
            </div>
          `;
          }
  ...
  d.addEventListener('click', async e => {
        ...
        if (result.isConfirmed) {
          ...
          if (!$('#placa').val()) {
            ...
            if ($('#placa').val().length != 6) {
              msg_error += '<p>El campo placa debe tener 6 caracteres, 3 letras y 3 números para poder actualizar el Vehículo.</p>';
            }
          }
          if (!$('#color_tabla').val() && !$('#id_vehiculo_color').val()) {
          ...
          if (!$('#modelo').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Modelo</strong> para poder actualizar el Vehículo.</p>';
          } else {
            if ($('#modelo').val().length != 4) {
              msg_error += '<p>El campo <strong>Modelo</strong>debe tener 4 dígitos para poder actualizar el Vehículo.</p>';
            }
          }
          if (!$('#peso_vacio').val()) {
            ...
            if ($('#peso_vacio').val().length < 1 || $('#peso_vacio').val().length > 5) {
              msg_error += '<p>El campo <strong>Peso Vacío</strong> debe ser mínimo 1 máximo 5 dígitos para poder actualizar el Vehículo.</p>';
            }
          }
          if (!$('#numero_poliza').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Número SOAT</strong> para poder actualizar el Vehículo.</p>';
          } else {
            if ($('#numero_poliza').val().length > 20) {
              msg_error += '<p>El campo <strong>Número SOAT</strong>debe tener máximo 20 caracteres para poder actualizar el Vehículo.</p>';
            }
          }
          if ($('#numero_polizaRC').val()) {
            if ($('#numero_polizaRC').val().length < 11 || $('#numero_polizaRC').val().length > 30) {
              msg_error += '<p>El campo <strong>Póliza Responsabilidad Civil</strong> debe tener mínimo 11 ó máximo 30 caracteres para poder actualizar el Vehículo.</p>';
            }
          }
          if (!$('#soat_vencimiento').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Vencimiento SOAT</strong> para poder actualizar el Vehículo.</p>';
          }
          if (!$('#aseguradora_tabla').val() && !$('#id_vehiculo_aseguradora').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Aseguradora</strong> para poder actualizar el Vehículo.</p>';
          }
          if (!$('#web_satelital').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Web satelital</strong> para poder actualizar el Vehículo.</p>';
          }
          if (!$('#usuario_satelital').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Usuario satelital</strong> para poder actualizar el Vehículo.</p>';
          } else {
            if ($('#usuario_satelital').val().length > 80) {
              msg_error += '<p>El campo <strong>Usuario satelital</strong> debe tener máximo 30 caracteres para poder actualizar el Vehículo.</p>';
            }
          }
          if (!$('#clave_satelital').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Clave satelital</strong> para poder actualizar el Vehículo.</p>';
          } else {
            if ($('#clave_satelital').val().length > 80) {
              msg_error += '<p>El campo <strong>Clave satelital</strong> debe tener máximo 30 caracteres para poder actualizar el Vehículo.</p>';
            }
          }
          if (!$('#num_motor').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Número motor</strong> para poder actualizar el Vehículo.</p>';
          } else {
            if ($('#num_motor').val().length < 6 || $('#num_motor').val().length > 40) {
              msg_error += '<p>El campo <strong>Número motor</strong> debe tener máximo 40 y mínimo 6 caracteres para poder actualizar el Vehículo.</p>';
            }
          }
          if (!$('#num_chasis').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Número chasis</strong> para poder actualizar el Vehículo.</p>';
          } else {
            if ($('#num_chasis').val().length < 6 || $('#num_chasis').val().length > 40) {
              msg_error += '<p>El campo <strong>Número chasis</strong> debe tener máximo 40 y mínimo 6 caracteres para poder actualizar el Vehículo.</p>';
            }
          }
          if (!$('#tipovinculacion').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Tipo de vinculación</strong> para poder actualizar el Vehículo.</p>';
          }
          if (!$('#capacidad_tn').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Capacidad de carga(Kg)</strong> para poder actualizar el Vehículo.</p>';
          } else {
            if ($('#capacidad_tn').val().length > 5) {
              msg_error += '<p>El campo <strong>Capacidad de carga(Kg)</strong> debe tener 5 dígitos máximo para poder actualizar el Vehículo.</p>';
            }
          }
          if (!$('#peso_bruto').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Peso Bruto (Kg)</strong> para poder actualizar el Vehículo.</p>';
          }

          if (!$('#clase_v').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Clase de Vehículo</strong> para poder actualizar el Vehículo.</p>';
          }

          if (!$('#repotencia').val()) {
            msg_error += '<p>Por favor seleccione una opción del campo <strong> Repotenciar </strong> para poder actualizar el Vehículo.</p>';
          }

          if ($('#repotencia').val() == 1) {
            if (!$('#repotenciado').val()) {
              msg_error += '<p>Debe diligenciar el campo <strong>repotenciado a:</strong> para poder actualizar el Vehículo.</p>';
            }
          }
          if ($('#repotencia').val() == 0) {
            $('#repotenciado').val('');
          ...
          if (!$('#f_matricula').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Fecha de matrícula</strong> para poder actualizar el Vehículo.</p>';
          }

          if (!$('#cant_viaje').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Cant. viajes</strong> para poder actualizar el Vehículo.</p>';
          }
          ...
          if ($('#f_matricula').val()) {
            ...
            if (tf >= 730) {
              ...
              if ($('#name_tecno_edit').val() === '') {
                if (!$('#foto_tecno').val()) {
                  msg_error += '<p>Debe ingresar <strong>Archivo Tecnomecánica</strong> para poder actualizar el Vehículo, ya que la fecha de matrícula es mayor a dos años días(' + tf + ').</p>';
                }
                if (!$('#tecnomecanica').val()) {
                  msg_error += '<p>Debe diligenciar el campo <strong>Tecnomecánica</strong> para poder actualizar el Vehículo días(' + tf + ').</p>';
                } else {
                  if ($('#tecnomecanica').val().length < 2 || $('#tecnomecanica').val().length > 20) {
                    msg_error += '<p>El campo <strong>CaTecnomecanica </strong> debe tener 20 dígitos máximo para poder actualizar el Vehículo</p>';
                  }
                }
              }
            } else {
              if ($('#tecnomecanica').val()) {
                if ($('#tecnomecanica').val().length < 2 || $('#tecnomecanica').val().length > 20) {
                  msg_error += '<p>El campo <strong>Tecnomecanica </strong> debe tener 20 dígitos máximo para poder actualizar el Vehículo</p>';
                }
              }
            }
          }
          if (!$('#cedula_propietario').val() && !$('#id_propietario').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Documento Propietario</strong> para poder actualizar el VehículoS1.</p>';
          }
          if (!$('#cedula_tenedor').val() && !$('#id_tenedor').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Documento Tenedor</strong> para poder actualizar el Vehículo.</p>';
          }
          if (!$('#cedula_conductor').val() && !$('#id_conductor').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Documento Conductor</strong> para poder actualizar el Vehículo.</p>';
          }
          if (!$('#id_propietario').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Propietario en Datos Específicos</strong> para poder actualizar el Vehículo.</p>';
          }
          if (!$('#id_tenedor').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Poseedor en Datos Específicos</strong> para poder actualizar el Vehículo.</p>';
          }
          if (!$('#id_conductor').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Conductor en Datos Específicos</strong> para poder actualizar el Vehículo.</p>';
          }

          if (!$('#configuracion').val() && !$('#id_vehiculo_configuracion').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Configuración completa</strong> para poder actualizar el Vehículo.</p>';
          } else {
            if (
              $('#configuracion').val() != 2 ||
              $('#configuracion').val() != 3 ||
              ...
              if (!$('#trailers').val()) {
                msg_error += '<p>Debe diligenciar el campo <strong>Trailer</strong> para poder actualizar el Vehículo.</p>';
              }
            }
          }
          if ($('#peso_vacio').val() == 0) {
          ...
          if (!$('#empresa_satelital').val()) {
            msg_error += '<p>Debe diligenciar el campo <strong>Empresa Satelital</strong> para poder actualizar el Vehículo.</p>';
          }

          if ($('#lice_transito').val()) {
            if ($('#lice_transito').val().length < 6 || $('#lice_transito').val().length > 30) {
              msg_error += '<p>El campo <strong>Licencia Tránsito</strong> debe tener mínimo 6 ó máximo 30 caracteres para poder actualizar el Vehículo.</p>';
            }
          }
          ...
          var existe_preoperacional = document.getElementById('existe_preoperacional');
          if (existe_preoperacional.textContent === 'sin documento') {
            var fileInput = document.getElementById('documento_preopeacional').files[0];
          ...
          if (!msg_error) {
            Actualizar_Vehiculo(decodificarBase64(numVehiculo));
    ...
    if (e.target.matches('#btn-cerrar-mensajes') || e.target.matches('#btn-cerrar-mensajes *')) {
      ...
      window.location = `${$('#id_url_ajax').val()}solicitudes/vehiculos/?idmenu=${valores}`;
    }
...
async function Actualizar_Vehiculo(num_vehiculo) {
  $('.nexos_messages_popup').html('');
  $('#loading-overlay-nexosapp ').css('display', 'flex'); // Mostrar mensaje de carga
  var datos = null;
  datos = new FormData();
  ...
  //numero soat
  datos.append('numero_soat', $('#numero_poliza').val());
  ...
  datos.append('numero_poliza', $('#numero_polizaRC').val());
  datos.append('fecha_poliza', $('#fecha_poliza').val());
  datos.append('repotenciado', $('#repotenciado').val());
  ...
  /* Numdoc dle vehiculo */
  datos.append('num_vehiculo', num_vehiculo);

  //editar datos del trailer
  //tres eventos 1 sin trailer,2 con trailer update new ,
  var trailer = $('#trailers').val();
  // console.log('🚀 ~ Actualizar_Vehiculo ~ trailer:', trailer.length);
  if (trailer == 'NA') {
    datos.append('trailers', $('#trailers').val());
    datos.append('trailer_anterior', $('#trailer_anterior').val());
  ...
  try {
    const response = await fetch($('#id_url_ajax').val() + 'vehiculos/Actualizar_vehiculo', {
      method: 'POST',
      body: datos,
      cache: 'no-cache',
    });
...
async function Actualiza_Dato_Ministerio(placa) {
  ...
  try {
    ...
    const data = await response.json();
    var tablas_locales = 'Se Actualizo Datos Exitosamente RNDC';
    if (data.status == 'true') {
      var contenidoHTML1 =
...
async function Actualiza_Dato_Oet() {
