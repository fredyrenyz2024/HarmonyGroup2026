...
window.initScript = function (id) {
  ...
  listar_pedidos_en_curso(fechaColombia, fechaColombia);
  ...
  document.addEventListener("click", async (e) => {
    ...
    if (e.target.matches(`#campo-${window.VENTANA}-buscar`) || e.target.matches(`#campo-${window.VENTANA}-buscar *`)) {
      ...
      listar_pedidos_en_curso(fecha_inicial, fecha_final);
    }
...
async function listar_pedidos_en_curso(fecha_inicial, fecha_final) {
